...
def solve_wave_leapfrog(
    ...
    Raises:
        ValueError: If the grid counts are too small, physical parameters are
            not positive and finite, the derived Courant number is unstable,
            or ``courant`` disagrees with the derived value.
    """
    if nx < 3:
