"""End-to-end tests of the documented wave-task invocation protocol."""
...
def test_entrypoint_runs_from_task_root_and_writes_contract_archive(tmp_path: Path) -> None:
    input_path = write_input(tmp_path / "input.json", make_input(NX, 160, 0.7, 1.3, 0.25))
...
def test_entrypoint_exits_non_zero_on_unstable_cfl(tmp_path: Path) -> None:
